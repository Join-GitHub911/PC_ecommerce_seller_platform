...
__decorate([
    (0, typeorm_1.PrimaryGeneratedColumn)("uuid", { comment: "购物车项ID" }),
...
__decorate([
    (0, typeorm_1.Column)("int", { comment: "商品数量" }),
    __metadata("design:type", Number)
], CartItem.prototype, "quantity", void 0);
__decorate([
    (0, typeorm_1.Column)("decimal", { precision: 10, scale: 2, comment: "商品单价" }),
    __metadata("design:type", Number)
], CartItem.prototype, "price", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: "json", nullable: true, comment: "商品规格" }),
    __metadata("design:type", Object)
], CartItem.prototype, "specifications", void 0);
__decorate([
